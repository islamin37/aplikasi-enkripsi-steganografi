...
public class Enkripsi extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Input String Plain Text atau Pilih File TXT untuk di enkripsi");
        ...
        submitButton.setText("Lakukan Enkripsi");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(443, 472, Short.MAX_VALUE))))
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(keyInputField, javax.swing.GroupLayout.Alignment.TRAILING))
                        .addContainerGap())))
            .addGroup(layout.createSequentialGroup()
                .addGap(10, 10, 10)
...
//        TODO add your handling code here:  
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        if (plainText.equals("") || encryptKey.equals("")) {
            ...
            if (plainText.equals(_temp_plain) && encryptKey.equals(_temp_key)) {
                JOptionPane.showMessageDialog(null, "Silahkan masukkan plain text atau kunci yang lain", "Kesalahan", 1);
            } else {
                RC4 rc4 = new RC4();
    ...
    private void saveAsFileButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveAsFileButtonActionPerformed
        ...
        if (saveToFile == true) {
            ...
            if (result.equals("")) {
                JOptionPane.showMessageDialog(null, "Silahkan lakukan enkripsi terlebih dahulu", "Kesalahan", 2);
            } else {
                try {
                    ...
                    String savedFile = saveToPath + "\\" + time + "_hasil_enkripsi.txt";
